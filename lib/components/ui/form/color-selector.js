...
var react_ui_dropdown_1 = require("react-ui-dropdown");
...
var UIColorSelector = (function (_super) {
    ...
    UIColorSelector.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "ui-form-color-select" },
            React.createElement(react_ui_dropdown_1.UIDropdown, { globalPositioned: this.props.globalPositionedDropdown, handlerClassName: "current", itemElementsClassName: "item" },

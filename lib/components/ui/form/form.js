...
var ReactValidForm = (function (_super) {
    __extends(ReactValidForm, _super);
    ...
    ReactValidForm.prototype.componentDidMount = function () {
        this.cardFormat = new cards_format_1.CardsFormat;
    };
    ReactValidForm.prototype.getChildContext = function () {
        var _this = this;
        return {
    ...
    ReactValidForm.prototype.validateField = function (field) {
        var _this = this;
        var validTypes = [];
        var invalidTypes = [];
    ...
    ReactValidForm.prototype.resetForm = function () {
        var _this = this;
    ...
    ReactValidForm.prototype.proxyValue = function (name, value) {
        var _this = this;
        _.each(this.fields, function (field, i) {
            if (field.name == name) {
    ...
    ReactValidForm.prototype.getModel = function (fields) {
        var model = {};
    ...
    ReactValidForm.prototype.submit = function (event) {
        var _this = this;
        var allIsValid = true;
        var invalidFields = [];
        if (event) {
    ...
    ReactValidForm.prototype.getInvalidMessagesArray = function (fields) {
        var messages = [];
    ...
    ReactValidForm.prototype.getInvalidMessages = function () {
        return this.state.invalidMessages.map(function (message) {
            return (React.createElement("p", null, message));
        });
    };
    ReactValidForm.prototype.getClassName = function (isActive, baseName, activeName, inactiveName) {
    ...
    ReactValidForm.prototype.render = function () {
        var _this = this;
    ...
    return ReactValidForm;
}(React.Component));
ReactValidForm.childContextTypes = {
...
exports.ReactValidForm = ReactValidForm;
